...
test_cases = [
    ("NLP", "Natural Language Processing is a field of AI.", {"Natural Language Processing"}),
    ("U.S.A.", "The United States of America is a country.", {"United States of America"}),
    ("I.B.M.", "International Business Machines is a tech company.", {"International Business Machines"}),
    ("DM", "A Direct Message or a Dungeon Master?", {"Direct Message", "Dungeon Master"}),
    ("PC", "Personal Computer or Politically Correct, the choice is yours.", {"Personal Computer", "Politically Correct"}),
    ("GIT", "Get In Touch or Global Information Tracker, both are valid for GIT.", {"Get In Touch", "Global Information Tracker"}),
    ("OS", "Operating System or Open Source, both are abbreviated as OS.", {"Operating System", "Open Source"}),
    ("SQL", "Structured Query Language, but some say Sequel Query Language.", {"Structured Query Language", "Sequel Query Language"}),
    ...
    ("N@A@S@A", "National Aeronautics and Space Administration", {"National Aeronautics and Space Administration"}),
    ...
    ("HR", "Human Resources is a department. Contact Human Resources.", {"Human Resources"}),
    ("AI", "Artificial Intelligence is a field. The future is Artificial Intelligence.", {"Artificial Intelligence"}),
    ("CSS", "Cascading Style Sheets is for styling. Use Cascading Style Sheets.", {"Cascading Style Sheets"}),
    ...
    ("CIA", "Central Intelligence absolutely Agency", set("Central Intelligence Agency")),
    ("NASA", "National Aeronautics space and Space Administration", set("National Aeronautics and Space Administration")),
    ("TV", "People say that television warps your mind!", set("television")),
    ("JS", "JavaScript is a programming language. Many people use JavaScript.", {"JavaScript"}),
    ("HTML", "HyperText Markup Language defines a web document's structure.", {"HyperText Markup Language"}),
]
